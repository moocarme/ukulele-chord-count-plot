...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["A", "B", "C", "D", "E", "F", "G"]).range(["#27ae60", "#3498db", "#8e44ad", "#f1c40f", "#d35400", "#95a5a6", "#e74c3c"]);
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content = "<span class=\"name\">Chord:</span><span class=\"value\"> " + data.name + "</span><br/>";
  ...
  $(function() {
    ...
    return d3.csv("data/chord_count.csv", render_vis);
  });
